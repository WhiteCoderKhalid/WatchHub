...
import 'package:watch_app/services/firebase_auth_services.dart';
...
class AuthController extends GetxController {
  ...
  void _loadInitialState() {
    ...
    // Check Firebase auth state instead of only local storage
  ...
  void _listenToAuthChanges() {
    FirebaseAuthService.authStateChanges.listen((User? user) {
      // update state when Firebase user changes
      _user.value = user;
